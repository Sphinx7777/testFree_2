...
export const Header = () => {
	...
	return (
		<>
			...
			<div style={{textAlign: 'left'}}><span>Добрый день.
				К сожалению потратил всю субботу прежде чем понял что пошел не по тому пути.<br/>
				...
				но c таким переплетением id для описания и редактирования каждого отдельного контакта,
				сложно сказать успею ли к понедельнику(пока только частично добавление и удаление подсписков).<br/>
